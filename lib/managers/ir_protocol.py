...
class IRProtocol:
    ...
    def get_rx_name(self) -> str:
        ...
        return self._rx_protocols[self._index].name

    def get_rx(
        self,
    ):
        """Returns the class of the current RX protocol."""
        return self._rx_protocols[self._index].protocol

    def get_tx_name(self) -> str:
        """Returns the name of the current TX protocol."""
        return self._tx_protocols[self._index].name

    def get_tx(
        self,
    ):
        """Returns the class of the current TX protocol."""
        return self._tx_protocols[self._index].protocol
